...
-   Start a [Dear Data]() "pen pal" with a peer, including at least 3 thoughtful
    entries.
...
-   [Copy the Masters]() by recreating a graphic from FiveThirtyEight using your
    favorite software.
-   [Make your own
...
|                  | Descriptions     |                 |
+------------------+------------------+-----------------+
| 3: 4/15, 4/17    | Data Journalism  | One Number      |
|                  |                  | Story           |
|                  | Spreadsheets,    |                 |
|                  | Summaries, and   |                 |
|                  | Pivot Tables     |                 |
...
|                  | Research Paper   |                 |
+------------------+------------------+-----------------+
| 6: 5/13, 5/15    | Storyboarding    | Group           |
|                  |                  | Storyboard      |
+------------------+------------------+-----------------+
| 8: 5/20, 5/22    | Visit from       | Build Your      |
...
|                  | Online Presence  |                 |
+------------------+------------------+-----------------+
| 9: 5/28, 5/29    | Understanding    | Final Report    |
...
|                  | Wednesday**      |                 |
+------------------+------------------+-----------------+
| Finals           | **Mon., June     | Final Report    |
|                  | 10th at**        | Revisions       |
| *Reserve these   | **7:10 - 10am:** |                 |
| times for        | Section 01 *(if  |                 |
| potential final  | you come to      |                 |
| grade meetings.* | class 8:10 -     |                 |
|                  | 9am)*            |                 |
|                  |                  |                 |
|                  | **Wed., June     |                 |
|                  | 12th at 7:10 -   |                 |
