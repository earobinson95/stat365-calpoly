...
::: callout-warning
As of May 5th, we will be using our discord server to conduct a "Pseudo, NYT What's Going on in This Graph" due to the end of the NYT activity for this academic year.
:::
...
+ Keep a weekly log/journal of your reflection. This is a compilation of all your submissions which you will submit to Canvas at the end of the quarter. You might want to include screenshots of the graphs, links to the articles, etc. in this log.
