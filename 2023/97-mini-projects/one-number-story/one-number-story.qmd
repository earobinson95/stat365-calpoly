...
-   English Language Learners: [codebook](https://www.cde.ca.gov/ds/ad/fselsch.asp); [download data](data/ell.xlsx)

-   College Going Rate: [codebook](https://www.cde.ca.gov/ds/ad/fscgr12.asp); [download data](data/cgr.xlsx)

-   English Language Arts/Literacy and Mathematics Test Scores: [codebook](https://caaspp-elpac.ets.org/caaspp/ResearchFileListSB?ps=true&lstTestYear=2022&lstTestType=B&lstCounty=00&lstDistrict=00000); [download data](data/catesting.xlsx) *Note: I aggregated to the county and grade level with weights*.

<!-- -   Science [download data](data/science_test.xlsx) -->
...
-   General Social Survey: [download data](data/gss_clean.xlsx) *(codebook in sheet 2)*
