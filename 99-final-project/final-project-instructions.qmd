...
| Formal Protocol                         |                                  |
+-----------------------------------------+----------------------------------+
| Peer Review of Formal Protocol          |                                  |
+-----------------------------------------+----------------------------------+
| Data Collection                         |                                  |
+-----------------------------------------+----------------------------------+
...
Your first assignment is to propose a research project for which you can easily gather data, in 1-2 days.
...
-   You will submit a **short initial proposal** to me for initial feedback by xxxx, xxxx.
-   You will submit a **formal study protocol**, as if to a Human Subjects Review board by xxx,xxx. This will be peer-reviewed by a fellow student who will conduct a pilot study, gathering about 5 observations.
:::

### Peer review formal study protocol {-}
...
Once you receive your peer reviewed feedback, you should conduct your study and collect data from the specified sample size in your proposal.

Make sure to store this data in a `.csv` or `.xlsx` file following the tidy data format (or be prepared to transform the data). Following reproducibility guidelines, this file should be saved within a data folder as your original file.

# Final Technical Report {.unnumbered}

Throughout the quarter, you will be writing a final technical report for your research project. The style of this should follow a typical scientific journal article. You will be provided with guidelines and resources to support your work, and you will receive feedback and guidance throughout the writing process.

I have outlined the sections to be included and their components below.
...
An Abstract/Executive Summary is often the last part written, and should be less than one page, 150-250 words.
...
-   Provide an overview of the organization of the document (tell the reader what you are going to tell them)
...
-   Figures and Tables numbered and in correct location (include captions, and figure alt. text).
