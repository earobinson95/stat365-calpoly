...
*Tip:* You will need to convert `id` to a dimension and use this as a `Detail` to get a point for each penguin.
...
Make sure **both** of your Tableau visualizations can be seen from the links you submitted.
...
1. `Publish as...` > `Projects` > `Palmer Penguins`
2. Check `Show sheets as tabs` and make sure to add your name
3. Publish
4. Go to workbook > Copy Paste URL to Canvas Assignment
