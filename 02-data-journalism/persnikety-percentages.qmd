...
4. Explain what’s wrong with this sentence: *"The difference in success rates between these two groups was about 45.4%."*

\vspace{2.5cm}

5. Describe two things that are lacking in this sentence: *"The difference in the success rates between the two groups was about 45.4 percentage points."*
...
6. Calculate the *percentage difference* in the success rates between the two groups, using the `Placebo` group as the baseline.  Also show how to calculate this from the ratio in Question 3. Then write a sentence that interprets this value.

\vspace{2.5cm}

7. Is it correct to say that the success rate with the placebo group was 86% less than the success rate with the high dose group?  Explain why or why not.  If not, calculate the correct value to replace 86% in this statement.
...
8. Is it correct to say that the odds of success in the high dose group are about 0.179?  Explain.  
...
10.  Explain what’s wrong with the following sentence and then revise the sentence in two different ways to correct the error: *"Successfully quitting smoking was about 2.05 times more likely with the nicotine lozenge than with the placebo lozenge."*

\vspace{2.5cm}

11. Calculate the odds of failing to quit smoking for each group.  Then calculate the odds ratio, using the nicotine group as the baseline.  How does this odds ratio compare to the previous one?
...
::: callout-note
The *relative risk * are calculated as
...
3. Calculate the *ratio* of the success rates between the two groups, using the `Placebo` group as the baseline; then write a sentence interpreting this value.