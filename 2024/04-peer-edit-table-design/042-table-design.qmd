...
ca_childcare |> 
  ...
  kbl(caption = "Table X. 58 counties...Means and Standard Deviations of the Guesses for Mandela's Age of Death for each Numerical Anchoring of Participants to a Younger or Older Age",
               col.names = c("Facility", "Year", "Mean ($)", "Std. Dev."),
               digits = 1
               ) |> 
  kable_minimal(full_width = F) |> 
  footnote(general = "Data was collected from xxxxx.")
```
