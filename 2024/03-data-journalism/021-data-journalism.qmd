...
+ Avoid using explicit variable or data set names in the data description.
+ Use strong verbs -- focus more on the data and study and less on "we decided to xxx".
+ Include references to data and other sources talked about.
+ Describe *how* key variables were measured.
+ Don't assume common knowledge of your reader (e.g., specific sports rules or a particular show).
