...
and for selecting appropriate methods to analyze data, building on students'
...
-   Develop technical proficiency in writing and producing technical reports
...
There will be three mini-projects throughout the semester, each designed to help
...
acquired throughout the semester. You will be required to choose a research
...
quarter. To use a token, you must send me an email and fill out the deadline
extension form [here](https://forms.gle/3uVhdWCN4DN373XE7).
