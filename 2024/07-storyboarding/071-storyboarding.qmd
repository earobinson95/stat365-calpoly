...
## NYT Reveals: Your 15 minutes of fame! {.scrollable}

[Hotter Summers](https://www.nytimes.com/2024/05/02/learning/whats-going-on-in-this-graph-may-8-2024.html)
...
[Global Electricity Sources](https://www.nytimes.com/2024/03/28/learning/whats-going-on-in-this-graph-april-10-2024.html)
...
[Shrinkflation](https://www.nytimes.com/2024/04/10/learning/whats-going-on-in-this-graph-april-17-2024.html)
...
[Young Adult Children Reaching Out to Parents](https://www.nytimes.com/2024/04/24/learning/whats-going-on-in-this-graph-may-1-2024.html)
...
## Dear Data Artists! {.scrollable}

```{r}
#| out-width: 100%
#| fig-align: center
knitr::include_graphics("../98-grade-boosters/dear-data-examples/permission-to-share/Alex_Tran.png")
```
...
#| out-width: 100%
#| fig-align: center
knitr::include_graphics("../98-grade-boosters/dear-data-examples/permission-to-share/William_Smithers.png")
```
...
#| out-width: 100%
#| fig-align: center
knitr::include_graphics("../98-grade-boosters/dear-data-examples/permission-to-share/Alvaro_Ramos.png")
```
...
#| out-width: 100%
#| fig-align: center
knitr::include_graphics("../98-grade-boosters/dear-data-examples/Alexandra_Sullivan.png")
```
...
#| out-width: 100%
#| fig-align: center
knitr::include_graphics("../98-grade-boosters/dear-data-examples/Megan_Kerner.png")
```
...
#| out-width: 100%
#| fig-align: center
knitr::include_graphics("../98-grade-boosters/dear-data-examples/permission-to-share/Nicole_Yee.png")
```
...
#| out-width: 100%
#| fig-align: center
knitr::include_graphics("../98-grade-boosters/dear-data-examples/Franchesca_Garcia.png")
```
...
`r fontawesome::fa("flask")` Useful research tools to know
...
#| fig-align: center
#| out-width: 100%
knitr::include_graphics("images/connected-papers.png")
```

## [Elicit](https://elicit.com/?redirected=true)

```{r}
#| fig-align: center
#| out-width: 100%
knitr::include_graphics("images/elicit.png")
```
...
Use Visual editor in Quarto > insert > citations.

+ In-text citation will be added where your cursor is.
+ Full APA reference will be added to your .bib file

```
@article{waterman1989dengue,
  title={Dengue fever},
  author={Waterman, Stephen H and Gubler, Duane J},
