...
|                  | tables               |                                  |
+------------------+----------------------+----------------------------------+
| 3: 4/17, 4/19    | Descriptive          | CwD (ch. 3.1 - 3.3)              |
|                  | Statistics           |                                  |
|                  |                      |                                  |
|                  | Tables               |                                  |
+------------------+----------------------+----------------------------------+
| 4: 4/24, 4/26    | Intro to viz         | Storytelling with Data Podcast   |
|                  |                      | Episodes #27: what is data       |
|                  | Color                | visualization and #67: beginner  |
|                  |                      | mistakes in data viz             |
|                  |                      |                                  |
|                  |                      | Communicating Data with Tableau  |
|                  |                      | ch. 2                            |
+------------------+----------------------+----------------------------------+
| 5: 5/1, 5/3      | Perception +         | Storytelling with Data Episode   |
|                  | Principles           | #8: The many myths of data       |
|                  |                      | visualization                    |
|                  | Simplification       |                                  |
|                  |                      | (Optional) Show me the numbers   |
|                  |                      | (ch. 5)                          |
+------------------+----------------------+----------------------------------+
| 6: 5/8, 5/10     | Statistical          | CwD ch. 7.1 - 7.5                |
|                  | Tendencies           |                                  |
|                  |                      | (Optional) CwD ch. 8.1 - 8.7     |
|                  | Writing reports      |                                  |
+------------------+----------------------+----------------------------------+
| 7: 5/15, 5/17    | ADEPT with Professor | Twenty-five Analogies for        |
|                  | Smith                | Explaining Statistical Concepts  |
|                  |                      | (Behar, Grima, and               |
|                  | Infographics &       | Margo-Almagro)                   |
|                  | Dashboards           |                                  |
+------------------+----------------------+----------------------------------+
