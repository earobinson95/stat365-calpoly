...
#| fig-align: center
#| out-width: 85%
knitr::include_graphics("images/pivot-table-proportions.png")
```

+ Write a sentence that interprets and compares the percentage of "success".
+ Calculate the *difference* between these percentages and also their *ratio*.  Then write a sentence interpreting each of these values.
...
$$percentage difference = (relative risk – 1) × 100%.$$

### Odds Ratio

+ The *odds of success* are calculated as: (# of successes) / (# of failures).

+ The *odds against* an event are calculated as (# of failures) / (# of successes).
