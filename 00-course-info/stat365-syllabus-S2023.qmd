...
grades to distract us from being creative, taking risks, and ultimately finding our voices.
...
The [technical report project](https://earobinson95.github.io/stat365-calpoly/99-final-project/final-project-instructions.html) is the culminating assignment of the course, where
you will have the opportunity to apply all the skills and knowledge you have
acquired throughout the quarter. This will be completed individually. You will
be required to choose a research question, collect and analyze data using
appropriate statistical methods, and produce a technical report that effectively
communicates your findings. You will be provided with guidelines and resources
to support your work, and you will receive feedback and guidance throughout the
project. The technical report project will be evaluated based on its clarity,
thoroughness, and adherence to standard statistical practices.
...
deadline extension form [here](https://forms.gle/3uVhdWCN4DN373XE7). The extension request must be submitted **before** the assignment due date.
...
|                  | Designing a Study     |                                  |
+------------------+-----------------------+----------------------------------+
| 2: 4/10, 4/12    | Data Journalism       | CwD (ch. 2), Numbers in the      |
|                  |                       | Newsroom (ch. 1, 2)              |
|                  | Spreadsheets,         |                                  |
|                  | summaries, and pivot  |                                  |
|                  | tables                |                                  |
+------------------+-----------------------+----------------------------------+
| 3: 4/17, 4/19    | Descriptive           | CwD (ch. 3.1 - 3.2)              |
|                  | Statistics + Tables   |                                  |
|                  |                       |                                  |
|                  | Reproducibility       |                                  |
+------------------+-----------------------+----------------------------------+
...
|                  |                       | 6)                               |
+------------------+-----------------------+----------------------------------+
| 6: 5/8, 5/10     | Statistical           | Twenty-five Analogies for        |
|                  | Tendencies            | Explaining Statistical Concepts  |
|                  |                       | (Behar, Grima, and               |
|                  | Writing reports       | Margo-Almagro)                   |
+------------------+-----------------------+----------------------------------+
...
|                  | at** **1:10 - 4pm:**  |                                  |
| Reserve these    | Section 01 *(if you   |                                  |
| times for        | come to class 1:10 -  |                                  |
| potential final  | 2pm)*                 |                                  |
| grade meetings.  |                       |                                  |
|                  | **Monday, June 12th   |                                  |
|                  | at 1:10 - 4pm:**      |                                  |
